...
- `(ls)`
- `(ls -l) показує, які файли знаходяться в папці`
- `(clear) очистити консоль`
- `(mv ім'я ім'я) перейменувати/перемістити`
- `(rm ім'я) видалити файл`
- `(rmdir ім'я) видалити папку`
- `(touch ім'я ) створити файл`
- `(mkdir ім'я ) створити папку`
